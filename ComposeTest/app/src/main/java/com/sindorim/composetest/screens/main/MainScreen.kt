...
fun MainScreen(
    ...
    Surface(
        ...
        Column(
            ...
            Button(
                onClick = {
                    navController.navigate(MyScreens.FlowExampleScreen.name)
                },
                modifier = Modifier.padding(bottom = 8.dp)
            ) {
                Text(text = "FlowExampleScreen", color = Color.White)
            }

            Button(
                onClick = {
                    navController.navigate(MyScreens.FlowNetworkScreen.name)
                },
                modifier = Modifier.padding(bottom = 8.dp)
            ) {
                Text(text = "FlowNetworkScreen", color = Color.White)
            }
